  ...
  <table class="table">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td class="btn-view">
          <a class="btn add view-details" href="{{ url('rakitanku/'.$rakitan->code) }}" role="button"> View</a>
          <a class="btn add view-CheckOut-J" href="{{ url('keranjang/'.$rakitan->code) }}" role="button"> Bayar</a>
