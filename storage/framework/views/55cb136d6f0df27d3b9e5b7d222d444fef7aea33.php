<script>
  ...
  $(document).ready(function () {
    $('.datatable').DataTable({
        ajax: '<?php echo e(url("admin/cpu/getAllDatatable")); ?>',
        serverSide: false,
        processing: true,
        deferRender: true,
        type: 'GET',
...
</script><?php /**PATH C:\laragon\www\bycom\resources\views/admin/pc-components/cpu/_script.blade.php ENDPATH**/ ?>