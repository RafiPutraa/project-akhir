            ...
            <div class="row">
              <div class="col-lg-6">
                <div class="component-pic mb-5 mt-4">
                    ...
                    <img src="<?php echo e(url('images/placeholder.jpg')); ?>" class="img-thumbnail shadow" id="output-img" width="200" alt="image"/>
                </div>
                  ...
                  <div class="col-lg-6">
                    ...
                    <div class="col-lg-6 mb-3">
                      <select id="cpuSocketId" name="cpuSocketId" class="form-select p-2" required>
                        ...
                        <?php $__currentLoopData = $cpuSockets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cpuSocket): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <option value="<?php echo e($cpuSocket->id); ?>"><?php echo e($cpuSocket->socketName); ?></option>
...
<?php /**PATH C:\laragon\www\bycom\resources\views/admin/pc-components/cpu/_modal.blade.php ENDPATH**/ ?>